...
The same legacy backend contains optional runtime profiles referencing the public `RankFTW/rhi-repo` release catalog. Current pinned archive hashes in AetherScale 0.5.2 are:
